...
pygame.display.set_caption("Snake catcher")
...
def welcome():
    ...
    while not exit_game:
        ...
        text_screen("Welcome to snake", black, 260, 220)
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_SPACE:
                    pygame.mixer.music.load("Alan Walker - Fade [NCS Release] (64 kbps).mp3")
    ...
    while not exit_game:
        if game_over:
            ...
            if head in snk_list[:-1]:
                game_over = True
                pygame.mixer.music.load("Hero_Theme.mp3")
                pygame.mixer.music.play()

            if snake_x < 0 or snake_x > screen_width or snake_y < 0 or snake_y > screen_height:
                game_over = True
                #pygame.mixer.music.load("Right Round- Florida.mp3")
                #pygame.mixer.music.play()
